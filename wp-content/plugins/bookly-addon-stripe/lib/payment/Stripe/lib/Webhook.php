...
abstract class Webhook
{
     ...
     * \BooklyStripe\Lib\Payment\Lib\Stripe\SignatureVerificationException if the signature verification
     ...
     * @return \BooklyStripe\Lib\Payment\Lib\Stripe\Event the Event instance
     * @throws \UnexpectedValueException if the payload is not valid JSON,
     * @throws \BooklyStripe\Lib\Payment\Lib\Stripe\Error\SignatureVerification if the verification fails.
     */
