			...
			<?php if ( $whitelabel_settings['enabled'] && ( is_wpmudev_member() || 'unit' === $membership_data['membership'] ) ) : ?>
				...
				<div class="sui-box-body">
					...
					<div class="sui-box-settings-row">
						...
						<div class="sui-box-settings-col-1">
							<span class="sui-settings-label"><?php esc_html_e( 'Documentation &amp; Tutorials', 'wpmudev' ); ?></span>
							<span class="sui-description"><?php esc_html_e( 'Remove the documentation button and the WPMU DEV tutorials from all plugin screens.', 'wpmudev' ); ?></span>
						</div>
